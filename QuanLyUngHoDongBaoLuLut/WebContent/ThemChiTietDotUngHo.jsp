...
<title>Thêm mới chi tiết đợt ủng hộ</title>
<link rel="stylesheet" href="css/bootstrap.min.css">
<link rel="stylesheet" href="css/style.css">
</head>
<body>
    <%
        String htuh = "",sluh = "", dvt = "";
        ...
        String htuhE = "", dvtE = "";
        if(request.getAttribute("htuhE") != null){
            htuhE = (String)request.getAttribute("htuhE");
        }
    ...
    <div id="content">
        <h3 style="text-align: center; color: red;">Thêm mới chi tiết đợt ủng hộ</h3>
        <form action="ChiTietDotUngHoServlet" method="post">
            <div class="form-group">
                <label>Mã đợt ủng hộ</label> <select class="form-control form-control-sm"
                    name="maDotUngHo">
                    <%
            ...
            <div class="form-group">
                <label><b>Hình thức ủng hộ</b> <span style="color: red"><%=htuhE %></span></label> <input type="text" class="form-control form-control-sm" placeholder="Hình thức ủng hộ"
                    name="hinhThucUngHo" value="<%=htuh %>">
            </div>
            <div class="form-group">
                <label><b>Số lượng ủng hộ</b></label> <input type="number" class="form-control form-control-sm" name="soLuongUngHo" value="<%=sluh %>" required="required">
            </div>
             <div class="form-group">
                <label><b>Đơn vị tính</b> <span style="color: red"><%=dvtE %></span></label> <input type="text" class="form-control form-control-sm" name="donViTinh" value="<%=dvt %>">
            </div>

            <button type="submit" class="btn btn-outline-success" name="loai" value="them">Thêm
                mới</button>
        </form>
    </div>
</body>
