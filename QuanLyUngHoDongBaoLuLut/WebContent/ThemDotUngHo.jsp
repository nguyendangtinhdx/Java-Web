...
<title>Thêm mới đợt ủng hộ</title>
...
<body>
    <%
        ...
        String mduhE = "", nuhE = "";
        if(request.getAttribute("mduhE") != null){
            mduhE = (String)request.getAttribute("mduhE");
        }
    ...
    <div id="content">
        <h3 style="text-align: center; color: red;">Thêm mới đợt ủng hộ</h3>
        <form action="DotUngHoServlet" method="post">
          <div class="form-group">
                <label><b>Mã đợt ủng hộ</b> <span style="color: red"><%=mduhE %></span></label> <input type="text"
                    class="form-control form-control-sm" placeholder="Mã đợt ủng hộ"
                    name="maDotUngHo" value="<%=mduh %>">
            </div>
            <div class="form-group">
                <label><b>Đơn vị ủng hộ</b></label> 
