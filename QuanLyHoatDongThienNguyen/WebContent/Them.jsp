...
<body>
    <%
        ...
        String mhdE = "", thdE = "", mthdE = "",ngbdE= "" ,ngktE = "",thdkE = "";
        if(request.getAttribute("mhdE") != null){
            mhdE = (String)request.getAttribute("mhdE");
        }
    ...
    <div id="content">
        <h3 style="text-align: center; color: red;">Thêm mới hoạt động thiện nguyện</h3>
        <form action="HoatDongServlet" method="post">
          <div class="form-group">
                <label><b>Mã hoạt động</b> <span style="color: red"><%=mhdE %></span></label> <input type="text"
                    class="form-control form-control-sm" placeholder="Mã hoạt động"
                    name="maHoatDong" value="<%=mhd %>">
            </div>
            <div class="form-group">
