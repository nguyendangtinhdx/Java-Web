...
<body>
    ...
    <div id="content">
        <h3 style="text-align: center; color: red;">Sửa khách hàng</h3>
        <form action="KhachHangServlet" method="post">
          <div class="form-group">
                <label><b>Mã khách hàng:</b></label> <input type="text"
                    class="form-control form-control-sm" placeholder="Mã khách hàng"
                    name="maKH"  value="<%=mkh %>" readonly="readonly">
            </div>
            <div class="form-group">
         ...
         <button type="submit" class="btn btn-outline-success" name="loai" value="sua" id="btnEdit">Sửa</button>
        </form>
    </div>
</body>
</html>