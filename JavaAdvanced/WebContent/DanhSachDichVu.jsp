...
<body>
    ...
    <div>
     <h3 style="text-align: center; color: red;">Thông tin dịch vụ</h3>
        <table class="table table-hover" style="width: 100%; margin: auto;">
            ...
            <tbody>
                    ...
                    <td><a href="DichVuServlet?loai=xoaDV&maDV=<%=d.getMaDV() %>" onclick="return checkDelete();"><img src="image/icon_delete.png"></a></td>
                    </tr>
                    <%
                        }
                    }
