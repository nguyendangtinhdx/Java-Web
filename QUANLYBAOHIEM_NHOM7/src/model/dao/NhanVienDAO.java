...
public class NhanVienDAO {
    ...
    public List<NhanVienBEAN> getAllNhanVien(int pageid, int count) throws SQLException {
        ...
        while(rs.next()){
            ...
            dsNhanVien.add(new NhanVienBEAN(maNhanVien, hoTen, ngaySinh, gioiTinh, soDienThoai, email, cmnd, diaChi, soTaiKhoan, nganHang, maChucVu));
        }
        con.connec.close();
        rs.close();
        return dsNhanVien;
    ...
    public int themNhanVien(String hoTen, Date ngaySinh, String gioiTinh, String soDienThoai, String email,
            String cmnd, String diaChi, String soTaiKhoan, String nganHang, String maChucVu) throws SQLException {
        con.getConnection();
...
con.getConnection();
        ...
        if(rs.next()){
            ...
            nhanVienBEAN = new NhanVienBEAN(maNhanVien, hoTen, ngaySinh, gioiTinh, soDienThoai, email, cmnd, diaChi, soTaiKhoan, nganHang, maChucVu);
        }
        con.connec.close();
        rs.close();
        return nhanVienBEAN;
    ...
    public int suaNhanVien(String maNhanVien, String hoTen, Date ngaySinh, String gioiTinh, String soDienThoai,
            String email, String cmnd, String diaChi, String soTaiKhoan, String nganHang, String maChucVu) throws SQLException {
        con.getConnection();
